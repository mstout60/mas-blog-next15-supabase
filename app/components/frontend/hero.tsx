        ...
        <div className="flex flex-row items-center justify-between text-sm lg:justify-start">
          <Link href="/" className="flex items-center gap-2">
            ...
            <h4 className="text-3xl font-semibold">
              Blog<span className="text-primary">MAS</span>
            </h4>
          </Link>
        ...
        <div className="relative items-center w-full py-12 lg:py-20">
          <div className="text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base font-light lg:text-lg text-muted-foreground tracking-tighter">
              Setting up your blog is hard and time consuming. Our solution
              makes it easier for anyone to create a blog in minutes!
            </p>
